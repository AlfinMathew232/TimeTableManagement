                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php if ($row[8] == 0) { ?><span class="text-success"> Active </span> <?php } else { ?><span class="text-danger"> Inactive </span> <?php } ?></td>
                                            <td class="text-end">
                                                <div class="actions ">

                                                    <a href="edit-student.php?sid=<?php echo $row[0] ?>" class="btn btn-sm bg-danger-light">
